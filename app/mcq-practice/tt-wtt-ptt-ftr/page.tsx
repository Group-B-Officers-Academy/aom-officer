...
import TimeTableWTTPTTFTR from '@/components/mcq-practice/TimeTableWTTPTTFTR'

const TimeTableWTTPTTFTRQuizPage = () => {
  return (
            ...
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2 flex items-center">
                  ...
                  Time Table WTT/PTT/FTR Quiz
                </h1>
                <p className="text-lg text-gray-600 ml-20">
                  Master Working Time Table (WTT), Public Time Table (PTT), Trains At A Glance (TAAG), and Full Tariff Rates (FTR) procedures
                </p>
              </div>
            </div>
          </div>
...
export default TimeTableWTTPTTFTRQuizPage
