...
import LongHaulTrains from '@/components/mcq-practice/LongHaulTrains'

const LongHaulTrainsQuizPage = () => {
  return (
            ...
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2 flex items-center">
                  ...
                  Long Haul Trains Quiz
                </h1>
                <p className="text-lg text-gray-600 ml-20">
                  Test your knowledge of Long Haul Train Operations and Procedures
                </p>
              </div>
            </div>
          </div>
...
export default LongHaulTrainsQuizPage
