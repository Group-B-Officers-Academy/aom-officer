...
import Signals from '@/components/mcq-practice/Signals'

const SignalsQuizPage = () => {
  return (
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 ml-20">
                  Test your knowledge of Railway Signals and Signalling Systems
                </p>
              </div>
            </div>
          </div>
...
export default SignalsQuizPage
