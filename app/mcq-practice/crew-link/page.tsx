...
import CrewLink from '@/components/mcq-practice/CrewLink'

const CrewLinkQuizPage = () => {
  return (
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 ml-20">
                  Master crew link procedures, power links, and operational protocols
                </p>
              </div>
            </div>
          </div>
...
export default CrewLinkQuizPage