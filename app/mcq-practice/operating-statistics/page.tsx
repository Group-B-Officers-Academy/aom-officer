...
// import OperatingStatistics from '@/components/mcq-practice/OperatingStatistics'

// const OperatingStatisticsQuizPage = () => {
//   return (
...
//                     </svg>
//                   </span>
//                   Operating Statistics Quiz
//                 </h1>
//                 <p className="text-lg text-gray-600 ml-20">
//                   Master statistical units, primary units, fundamental units, and derived units
//                 </p>
//               </div>
//             </div>
//           </div>
...
// export default OperatingStatisticsQuizPage
