...
const Vijayawada = () => {
  const notifications = [
    ...
    {
      id: 1,
      title: 'Shunting Master Gr.II in Level - 4',
      pdfName: 'Shunting Master BZA.pdf',
      publishedDate: '16-10-2025',
      lastDate: '28.10.2025',
      description: 'Filling up the vacancies of Shunting Master in Level - 7 of 7th CPC against 50% LDCE Quota of Operating Department in Vijayawada Division through CBT - Reg.'
    },
    {
        id: 2,
        title: 'Chief Controller in Level - 7',
        pdfName: 'Chief Controller BZA.pdf',
        publishedDate: '17-10-2025',
        lastDate: '29.10.2025',
        description: 'Filling up the vacancies of Chief Controller in Level - 7 of 7th CPC against 50% LDCE Quota of Operating Department in Vijayawada Division through CBT - Reg.'
      },
  ]
  ...
  const handleDownload = (pdfName: string) => {
    ...
    link.href = `/notifications/vijayawada/${pdfName}`
  ...
  return (
    <div className="min-h-screen bg-linear-to-r from-blue-50 via-indigo-50 to-purple-50 py-12 px-4 sm:px-6 lg:px-8">
      {/* Hero Section */}
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="lg:text-4xl text-xl font-bold text-gray-900 mb-4">
            Notifications in Vijayawada Division
          </h1>
          <p className="lg:text-lg text-base text-gray-600">
            Stay updated with the latest notifications and announcements for Vijayawada Division
          </p>
        </div>
