...
const GSR = () => {
  const handleDownload = () => {
    ...
    link.href = '/materials/Digital SCR G&SR 2020 upto AS 21.pdf'
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <h1 className="lg:text-5xl text-3xl md:text-4xl font-black mb-6 leading-tight bg-clip-text text-transparent bg-linear-to-r from-blue-600 via-indigo-600 to-purple-600">
              General & Subsidiary Rules (GSR)
            </h1>
            <p className="lg:text-xl text-base md:text-lg text-gray-600 font-medium max-w-3xl mx-auto leading-relaxed">
              Comprehensive rules and regulations governing the safe and efficient operation of the railway system
            </p>
          </div>
            ...
            <div className="relative space-y-8">
              ...
              <div className="text-center">
                    ...
                    <div className="relative bg-linear-to-r from-blue-500 to-indigo-600 rounded-2xl p-6 shadow-xl">
                      <div className="flex items-center justify-center gap-4">
                        ...
                        <div className="text-left">
                          <h2 className="text-white font-bold text-xl md:text-2xl mb-1">GSR Document</h2>
                          <p className="text-blue-100 text-sm md:text-base">2020 Edition upto AS 21</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <p className="text-gray-700 text-lg md:text-xl leading-relaxed max-w-4xl mx-auto">
                  The General & Subsidiary Rules (GSR) is a comprehensive document that contains essential rules and regulations 
                  for the operation of the railway system. It serves as a fundamental guide for railway personnel, covering 
                  operational procedures, safety protocols, and regulatory compliance requirements.
                </p>
              </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 border border-blue-100 hover:border-blue-200 transform hover:-translate-y-2">
                    <div className="text-center">
                      ...
                      <h3 className="text-xl font-bold text-gray-900 mb-2">Regulatory Framework</h3>
                      <p className="text-gray-600 leading-relaxed text-sm">
                        Comprehensive rules governing railway operations and safety standards
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 border border-indigo-100 hover:border-indigo-200 transform hover:-translate-y-2">
                    <div className="text-center">
                      ...
                      <p className="text-gray-600 leading-relaxed text-sm">
                        Detailed procedures for safe and efficient railway operations
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 border border-purple-100 hover:border-purple-200 transform hover:-translate-y-2">
                    <div className="text-center">
                      ...
                      <p className="text-gray-600 leading-relaxed text-sm">
                        Essential safety measures and compliance requirements
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="relative bg-linear-to-br from-emerald-50 to-teal-50 rounded-xl p-5 border border-emerald-100 hover:border-emerald-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">Fundamental operational principles and regulations</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="relative bg-linear-to-br from-blue-50 to-cyan-50 rounded-xl p-5 border border-blue-100 hover:border-blue-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">Supplementary procedures and guidelines</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="relative bg-linear-to-br from-purple-50 to-indigo-50 rounded-xl p-5 border border-purple-100 hover:border-purple-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">Updated rules up to AS 21 (Amendment Sheet 21)</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="relative bg-linear-to-br from-orange-50 to-amber-50 rounded-xl p-5 border border-orange-100 hover:border-orange-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">Mandatory adherence to operational standards</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
                    Download the complete Digital SCR G&SR 2020 document including all amendments up to AS 21
                  </p>
                  <div className="flex justify-center">
                    ...
                    >
                      ...
                      <span className="relative z-10">Download PDF Document</span>
                    </button>
                  </div>
                  <p className="text-sm text-gray-500 mt-4">
                    📄 Digital SCR G&SR 2020 upto AS 21.pdf
                  </p>
                </div>
              </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        This GSR document is essential reading for all railway personnel involved in operations. 
                        Ensure you have the latest version with all amendments incorporated. Regular updates and 
                        revisions are published as Amendment Sheets (AS) to keep the document current with 
