...
const Operating = () => {
  const topics = [
    ...
    },
    {
      ...
      description: 'Comprehensive guide for accident procedures, emergency protocols, and safety measures for railway operations',
      href: '/materials/opertating/accident-manual',
      icon: (
        <svg className="lg:w-12 lg:h-12 w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      id: 'stable-and-securing',
      title: 'Stable And Securing RDSO JPO Summary',
      description: 'Comprehensive guide for stable and securing procedures, RDSO Joint Procedure Orders, and operational protocols for railway safety',
      href: '/materials/opertating/stabe-and-securing',
      icon: (
        <svg className="lg:w-12 lg:h-12 w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
