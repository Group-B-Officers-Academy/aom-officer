            ...
            <div className="relative">
              <div className="text-center mb-4 sm:mb-6 md:mb-8">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto text-sm sm:text-base md:text-lg px-2">
                  Browse through the Eighth Pay Commission TOR page by page. Use controls below to navigate.
                </p>
              </div>
...
export default EighthPayCommissionTor
