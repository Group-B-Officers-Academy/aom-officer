...
const LeaveRules = () => {
  const handleDownload = () => {
    ...
    link.href = '/materials/RAILWAYSERVICESLEAVERULES.pdf'
    link.download = 'RAILWAYSERVICESLEAVERULES.pdf'
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <h1 className="lg:text-5xl text-3xl md:text-4xl font-black mb-6 leading-tight bg-clip-text text-transparent bg-linear-to-r from-blue-600 via-indigo-600 to-purple-600">
              Railway Service Leave Rules
            </h1>
            <p className="lg:text-xl text-base md:text-lg text-gray-600 font-medium max-w-3xl mx-auto leading-relaxed">
              Comprehensive rules and regulations governing leave entitlements, leave application procedures, and leave management for railway employees
            </p>
          </div>
            ...
            <div className="relative space-y-8">
              ...
              <div className="text-center">
                    ...
                    <div className="relative bg-linear-to-r from-blue-500 to-indigo-600 rounded-2xl p-6 shadow-xl">
                      <div className="flex items-center justify-center gap-4">
                        ...
                        <div className="text-left">
                          <h2 className="text-white font-bold text-xl md:text-2xl mb-1">Leave Rules Document</h2>
                          <p className="text-blue-100 text-sm md:text-base">Railway Service Leave Rules</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <p className="text-gray-700 text-lg md:text-xl leading-relaxed max-w-4xl mx-auto">
                  The Railway Service Leave Rules is a comprehensive document that contains essential rules and regulations 
                  for leave entitlements and management in the railway establishment. It serves as a fundamental guide for 
                  employees and administrators to understand various types of leave, their eligibility criteria, application 
                  procedures, and leave balance management.
                </p>
              </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 border border-blue-100 hover:border-blue-200 transform hover:-translate-y-2">
                    <div className="text-center">
                      ...
                      <h3 className="text-xl font-bold text-gray-900 mb-2">Leave Types</h3>
                      <p className="text-gray-600 leading-relaxed text-sm">
                        Comprehensive rules governing various types of leave and their eligibility
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 border border-indigo-100 hover:border-indigo-200 transform hover:-translate-y-2">
                    <div className="text-center">
                      ...
                      <h3 className="text-xl font-bold text-gray-900 mb-2">Application Procedures</h3>
                      <p className="text-gray-600 leading-relaxed text-sm">
                        Detailed guidelines for leave application and approval processes
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 border border-purple-100 hover:border-purple-200 transform hover:-translate-y-2">
                    <div className="text-center">
                      ...
                      <h3 className="text-xl font-bold text-gray-900 mb-2">Leave Balance</h3>
                      <p className="text-gray-600 leading-relaxed text-sm">
                        Essential standards for leave accrual and balance management
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-linear-to-br from-emerald-50 to-teal-50 rounded-xl p-5 border border-emerald-100 hover:border-emerald-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h4 className="font-bold text-gray-900 mb-1">Earned Leave</h4>
                          <p className="text-gray-600 text-sm">Rules governing earned leave accrual and utilization</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-linear-to-br from-blue-50 to-cyan-50 rounded-xl p-5 border border-blue-100 hover:border-blue-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        <span className="text-2xl">✓</span>
                        <div>
                          <h4 className="font-bold text-gray-900 mb-1">Casual Leave</h4>
                          <p className="text-gray-600 text-sm">Guidelines for casual leave entitlement and usage</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-linear-to-br from-purple-50 to-indigo-50 rounded-xl p-5 border border-purple-100 hover:border-purple-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        <span className="text-2xl">✓</span>
                        <div>
                          <h4 className="font-bold text-gray-900 mb-1">Special Leave</h4>
                          <p className="text-gray-600 text-sm">Rules for special leave categories and provisions</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="relative bg-linear-to-br from-orange-50 to-amber-50 rounded-xl p-5 border border-orange-100 hover:border-orange-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">Mandatory adherence to leave application and approval standards</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
                    Download the complete Railway Service Leave Rules document
                  </p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        This Leave Rules document is essential reading for all railway personnel involved in leave management, 
                        human resources, and administrative functions. It provides the legal framework for leave entitlements, 
                        application procedures, and leave balance management, ensuring compliance with service rules and protecting 
                        employee rights. Understanding these rules is crucial for proper leave planning and maintaining work-life balance 
                        in the railway organization.
                      </p>
                    </div>
                  </div>
                </div>
