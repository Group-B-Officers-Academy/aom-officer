...
const RTI = () => {
  const handleDownload = () => {
    ...
    link.href = '/materials/RTIACT2005.pdf'
    link.download = 'RTIACT2005.pdf'
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="lg:text-xl text-base md:text-lg text-gray-600 font-medium max-w-3xl mx-auto leading-relaxed">
              Comprehensive legislation promoting transparency and accountability in public administration through citizens&apos; right to access information
            </p>
          </div>
            ...
            <div className="relative space-y-8">
              ...
              <div className="text-center">
                    ...
                    <div className="relative bg-linear-to-r from-blue-500 to-indigo-600 rounded-2xl p-6 shadow-xl">
                      <div className="flex items-center justify-center gap-4">
                        ...
                        <div className="text-left">
                          <h2 className="text-white font-bold text-xl md:text-2xl mb-1">RTI Document</h2>
                          <p className="text-blue-100 text-sm md:text-base">2005 Act</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <p className="text-gray-700 text-lg md:text-xl leading-relaxed max-w-4xl mx-auto">
                  The Right to Information Act (RTI) 2005 is a comprehensive legislation that empowers citizens to access information 
                  held by public authorities. It serves as a fundamental tool for promoting transparency, accountability, and good 
                  governance in public administration, including railway services. The Act ensures that citizens have the right to 
                  seek information and receive timely responses from government bodies.
                </p>
              </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 border border-blue-100 hover:border-blue-200 transform hover:-translate-y-2">
                    <div className="text-center">
                      ...
                      <h3 className="text-xl font-bold text-gray-900 mb-2">Information Access</h3>
                      <p className="text-gray-600 leading-relaxed text-sm">
                        Comprehensive framework for citizens to access public information
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 border border-purple-100 hover:border-purple-200 transform hover:-translate-y-2">
                    <div className="text-center">
                      ...
                      <p className="text-gray-600 leading-relaxed text-sm">
                        Ensuring accountability of public authorities and officials
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-linear-to-br from-emerald-50 to-teal-50 rounded-xl p-5 border border-emerald-100 hover:border-emerald-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h4 className="font-bold text-gray-900 mb-1">Right to Information</h4>
                          <p className="text-gray-600 text-sm">Fundamental rights of citizens to seek information</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-linear-to-br from-blue-50 to-cyan-50 rounded-xl p-5 border border-blue-100 hover:border-blue-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        <span className="text-2xl">✓</span>
                        <div>
                          <h4 className="font-bold text-gray-900 mb-1">Application Process</h4>
                          <p className="text-gray-600 text-sm">Procedures for filing RTI applications and obtaining responses</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-linear-to-br from-purple-50 to-indigo-50 rounded-xl p-5 border border-purple-100 hover:border-purple-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        <span className="text-2xl">✓</span>
                        <div>
                          <h4 className="font-bold text-gray-900 mb-1">Exemptions</h4>
                          <p className="text-gray-600 text-sm">Information exempted from disclosure under the Act</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="relative bg-linear-to-br from-orange-50 to-amber-50 rounded-xl p-5 border border-orange-100 hover:border-orange-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">Mandatory adherence to RTI provisions and timelines</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
                    Download the complete Right to Information Act 2005 document
                  </p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        This RTI Act document is essential reading for all railway personnel involved in public information management, 
                        administrative functions, and citizen services. It provides the legal framework for handling information requests, 
                        ensuring transparency, and maintaining accountability in public administration. Understanding these provisions is crucial 
                        for proper implementation of the RTI Act and ensuring timely responses to information seekers while protecting 
                        sensitive information as per legal exemptions.
                      </p>
                    </div>
                  </div>
                </div>
