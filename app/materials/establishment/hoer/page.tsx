...
const HOER = () => {
  const handleDownload = () => {
    ...
    link.href = '/materials/HOERACT.pdf'
    link.download = 'HOERACT.pdf'
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <h1 className="lg:text-5xl text-3xl md:text-4xl font-black mb-6 leading-tight bg-clip-text text-transparent bg-linear-to-r from-blue-600 via-indigo-600 to-purple-600">
              Hours of Employment Rules (HOER)
            </h1>
            <p className="lg:text-xl text-base md:text-lg text-gray-600 font-medium max-w-3xl mx-auto leading-relaxed">
              Comprehensive rules and regulations governing working hours, rest periods, and employment conditions for railway employees
            </p>
          </div>
            ...
            <div className="relative space-y-8">
              ...
              <div className="text-center">
                    ...
                    <div className="relative bg-linear-to-r from-blue-500 to-indigo-600 rounded-2xl p-6 shadow-xl">
                      <div className="flex items-center justify-center gap-4">
                        ...
                        <div className="text-left">
                          <h2 className="text-white font-bold text-xl md:text-2xl mb-1">HOER Document</h2>
                          <p className="text-blue-100 text-sm md:text-base">Hours of Employment Rules Act</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <p className="text-gray-700 text-lg md:text-xl leading-relaxed max-w-4xl mx-auto">
                  The Hours of Employment Rules (HOER) is a comprehensive document that contains essential rules and regulations 
                  for working hours, rest periods, and employment conditions in the railway establishment. It serves as a fundamental guide 
                  for managing employee work schedules, ensuring adequate rest, and maintaining compliance with labor regulations.
                </p>
              </div>
                  ...
                  <div className="relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 border border-blue-100 hover:border-blue-200 transform hover:-translate-y-2">
                    <div className="text-center">
                      ...
                      <p className="text-gray-600 leading-relaxed text-sm">
                        Comprehensive rules governing maximum working hours and duty schedules
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 border border-indigo-100 hover:border-indigo-200 transform hover:-translate-y-2">
                    <div className="text-center">
                      ...
                      <h3 className="text-xl font-bold text-gray-900 mb-2">Rest Periods</h3>
                      <p className="text-gray-600 leading-relaxed text-sm">
                        Detailed guidelines for mandatory rest periods and break times
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 border border-purple-100 hover:border-purple-200 transform hover:-translate-y-2">
                    <div className="text-center">
                      ...
                      <h3 className="text-xl font-bold text-gray-900 mb-2">Employment Conditions</h3>
                      <p className="text-gray-600 leading-relaxed text-sm">
                        Essential standards for employment terms and working conditions
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-linear-to-br from-emerald-50 to-teal-50 rounded-xl p-5 border border-emerald-100 hover:border-emerald-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h4 className="font-bold text-gray-900 mb-1">Maximum Hours</h4>
                          <p className="text-gray-600 text-sm">Regulations regarding maximum working hours per day and week</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-linear-to-br from-blue-50 to-cyan-50 rounded-xl p-5 border border-blue-100 hover:border-blue-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        <span className="text-2xl">✓</span>
                        <div>
                          <h4 className="font-bold text-gray-900 mb-1">Rest Regulations</h4>
                          <p className="text-gray-600 text-sm">Mandatory rest periods between duty shifts</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-linear-to-br from-purple-50 to-indigo-50 rounded-xl p-5 border border-purple-100 hover:border-purple-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        <span className="text-2xl">✓</span>
                        <div>
                          <h4 className="font-bold text-gray-900 mb-1">Overtime Rules</h4>
                          <p className="text-gray-600 text-sm">Guidelines for overtime work and compensation</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="relative bg-linear-to-br from-orange-50 to-amber-50 rounded-xl p-5 border border-orange-100 hover:border-orange-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">Mandatory adherence to working hours and rest period standards</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
                    Download the complete Hours of Employment Rules Act document
                  </p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        This HOER document is essential reading for all railway personnel involved in workforce management, 
                        scheduling, and human resources. It provides the legal framework for working hours, rest periods, 
                        and employment conditions, ensuring compliance with labor laws and protecting employee welfare. 
                        Understanding these rules is crucial for maintaining work-life balance and ensuring fair employment 
                        practices in the railway organization.
                      </p>
                    </div>
                  </div>
                </div>
