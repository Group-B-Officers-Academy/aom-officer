...
const About = () => {
  return (
    <div className="min-h-screen bg-linear-to-r from-slate-50 via-blue-50 to-purple-50 relative overflow-hidden">
      ...
      <section className="relative py-12 overflow-hidden">
        <div className="absolute inset-0 bg-linear-to-r from-blue-600 via-purple-600 to-indigo-700"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col md:flex-row justify-start items-center gap-6 mt-8">
                  <div className="relative group w-full md:w-auto">
                    <div className="bg-linear-to-r from-blue-500 to-indigo-600 rounded-2xl p-6 shadow-2xl group-hover:scale-105 transition-transform duration-300 flex flex-col items-center">
                  ...
                  <div className="relative group w-full md:w-auto">
                    <div className="bg-linear-to-r from-green-400 to-emerald-600 rounded-2xl p-6 shadow-2xl group-hover:scale-105 transition-transform duration-300 flex flex-col items-center">
                  ...
                  <div className="relative group w-full md:w-auto">
                    <div className="bg-linear-to-r from-purple-500 to-pink-600 rounded-2xl p-6 shadow-2xl group-hover:scale-105 transition-transform duration-300 flex flex-col items-center">
                      <svg className="w-12 h-12 text-white mb-2 drop-shadow-lg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="relative flex justify-center lg:justify-end">
              <div className="group relative">
                ...
                <div className="absolute inset-0 bg-linear-to-r from-blue-400 to-purple-500 rounded-lg blur-2xl opacity-20 group-hover:opacity-40 transition-opacity duration-500"></div>
                <div className="relative">
                  ...
                  />
                  <div className="absolute inset-0 rounded-lg bg-linear-to-r from-blue-500/20 to-purple-500/20 group-hover:from-blue-500/30 group-hover:to-purple-500/30 transition-all duration-500"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0 bg-linear-to-r from-orange-50 via-yellow-50 to-pink-50"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="group relative">
              <div className="absolute inset-0 bg-linear-to-r from-blue-400 to-purple-500 rounded-3xl blur-2xl opacity-0 group-hover:opacity-30 transition-opacity duration-700"></div>
              <div className="relative bg-white rounded-3xl p-2 shadow-2xl hover:shadow-blue-300/50 transition-all duration-700 border border-blue-100 transform hover:-translate-y-3">
                <div className="relative overflow-hidden rounded-2xl">
                  ...
                  />
                  <div className="absolute inset-0 bg-linear-to-r from-blue-500/20 to-purple-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-2xl"></div>
            ...
            <div className="group relative">
              <div className="absolute inset-0 bg-linear-to-r from-green-400 to-emerald-500 rounded-3xl blur-2xl opacity-0 group-hover:opacity-30 transition-opacity duration-700"></div>
              <div className="relative bg-white rounded-3xl p-2 shadow-2xl hover:shadow-green-300/50 transition-all duration-700 border border-green-100 transform hover:-translate-y-3">
                <div className="relative overflow-hidden rounded-2xl">
                  <Image
                    ...
                    className="w-full h-auto rounded-2xl group-hover:scale-110 transition-transform duration-700"
                  />
                  <div className="absolute inset-0 bg-linear-to-r from-green-500/20 to-emerald-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-2xl"></div>
                  <div className="absolute bottom-4 left-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-700">
                    <div className="bg-white/90 backdrop-blur-md rounded-xl p-4 shadow-lg">
      ...
      <section className="relative py-24 overflow-hidden">
        <div className="absolute inset-0 bg-linear-to-r from-white via-blue-50 to-purple-50"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <div className="inline-block mb-4">
              <span className="px-4 py-2 bg-linear-to-r from-orange-100 to-red-100 text-orange-700 font-bold rounded-full text-sm uppercase tracking-wide">
                💫 Our Purpose
              </span>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="group relative">
              <div className="absolute inset-0 bg-linear-to-r from-blue-400 to-cyan-500 rounded-3xl blur-xl opacity-0 group-hover:opacity-30 transition-opacity duration-500"></div>
              <div className="relative bg-white backdrop-blur-sm rounded-3xl p-10 shadow-2xl border border-gray-100 hover:border-blue-300 transition-all duration-500 transform hover:-translate-y-2">
                <div className="text-center">
                  <div className="relative mb-8">
                    <div className="absolute inset-0 bg-linear-to-r from-blue-400 to-cyan-500 rounded-2xl blur-lg opacity-50"></div>
                    <div className="relative w-24 h-24 bg-linear-to-r from-blue-500 to-cyan-600 rounded-2xl flex items-center justify-center mx-auto shadow-xl">
                      <span className="text-5xl">🎯</span>
                    </div>
                  </div>
                  <h3 className="text-3xl font-black bg-clip-text text-transparent bg-linear-to-r from-blue-600 to-cyan-600 mb-6">Our Mission</h3>
            ...
            <div className="group relative">
              <div className="absolute inset-0 bg-linear-to-r from-purple-400 to-pink-500 rounded-3xl blur-xl opacity-0 group-hover:opacity-30 transition-opacity duration-500"></div>
              <div className="relative bg-white backdrop-blur-sm rounded-3xl p-10 shadow-2xl border border-gray-100 hover:border-purple-300 transition-all duration-500 transform hover:-translate-y-2">
                <div className="text-center">
                  <div className="relative mb-8">
                    <div className="absolute inset-0 bg-linear-to-r from-purple-400 to-pink-500 rounded-2xl blur-lg opacity-50"></div>
                    <div className="relative w-24 h-24 bg-linear-to-r from-purple-500 to-pink-600 rounded-2xl flex items-center justify-center mx-auto shadow-xl">
                      <span className="text-5xl">🌟</span>
                    </div>
                  </div>
                  <h3 className="text-3xl font-black bg-clip-text text-transparent bg-linear-to-r from-purple-600 to-pink-600 mb-6">Our Vision</h3>
                  <p className="text-lg text-gray-700 leading-relaxed font-medium">
      ...
      {/* Academy Features */}
      <section className="relative py-24 overflow-hidden">
        <div className="absolute inset-0 bg-linear-to-r from-white via-indigo-50 to-purple-100
        "></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <div className="inline-block mb-4">
              <span className="px-4 py-2 bg-linear-to-r from-indigo-100 to-purple-100 text-indigo-700 font-bold rounded-full text-sm uppercase tracking-wide">
                ⭐ Why Choose Us
              </span>
            </div>
            <h2 className="lg:text-5xl text-3xl font-black bg-clip-text text-transparent bg-linear-to-r from-indigo-600 via-purple-600 to-pink-600 mb-6 leading-tight">
              What Sets Us Apart
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="group relative">
              <div className="absolute inset-0 bg-linear-to-br from-blue-400 to-indigo-500 rounded-2xl blur-lg opacity-0 group-hover:opacity-40 transition-opacity  duration-500"></div>
              <div className="relative bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-blue-300 transform hover:-translate-y-3">
                <div className="text-center">
                  <div className="relative mb-6">
                    <div className="absolute inset-0 bg-linear-to-r from-blue-400 to-indigo-500 rounded-xl blur-md opacity-50 group-hover:opacity-70 transition-opacity duration-500"></div>
                    <div className="relative w-20 h-20 bg-linear-to-r from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center mx-auto shadow-lg">
            ...
            <div className="group relative">
              <div className="absolute inset-0 bg-linear-to-r from-green-400 to-emerald-500 rounded-2xl blur-lg opacity-0 group-hover:opacity-40 transition-opacity duration-500"></div>
              <div className="relative bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-green-300 transform hover:-translate-y-3">
                <div className="text-center">
                  <div className="relative mb-6">
                    <div className="absolute inset-0 bg-linear-to-r from-green-400 to-emerald-500 rounded-xl blur-md opacity-50 group-hover:opacity-70 transition-opacity duration-500"></div>
                    <div className="relative w-20 h-20 bg-linear-to-r from-green-500 to-emerald-600 rounded-xl flex items-center justify-center mx-auto shadow-lg">
                      <span className="text-4xl">💻</span>
                    </div>
                  </div>
            ...
            <div className="group relative">
              <div className="absolute inset-0 bg-linear-to-r from-purple-400 to-pink-500 rounded-2xl blur-lg opacity-0 group-hover:opacity-40 transition-opacity duration-500"></div>
              <div className="relative bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-purple-300 transform hover:-translate-y-3">
                <div className="text-center">
                  <div className="relative mb-6">
                    <div className="absolute inset-0 bg-linear-to-r from-purple-400 to-pink-500 rounded-xl blur-md opacity-50 group-hover:opacity-70 transition-opacity duration-500"></div>
                    <div className="relative w-20 h-20 bg-linear-to-r from-purple-500 to-pink-600 rounded-xl flex items-center justify-center mx-auto shadow-lg">
                      <span className="text-4xl">📝</span>
                    </div>
                  </div>
            ...
            <div className="group relative">
              <div className="absolute inset-0 bg-linear-to-r from-orange-400 to-red-500 rounded-2xl blur-lg opacity-0 group-hover:opacity-40 transition-opacity duration-500"></div>
              <div className="relative bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-orange-300 transform hover:-translate-y-3">
                <div className="text-center">
                  <div className="relative mb-6">
                    <div className="absolute inset-0 bg-linear-to-r from-orange-400 to-red-500 rounded-xl blur-md opacity-50 group-hover:opacity-70 transition-opacity duration-500"></div>
                    <div className="relative w-20 h-20 bg-linear-to-r from-orange-500 to-red-600 rounded-xl flex items-center justify-center mx-auto shadow-lg">
                      <span className="text-4xl">🤝</span>  
                    </div>
                  </div>
