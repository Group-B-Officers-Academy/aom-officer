...
const OperatingManual = () => {
  const handleDownload = () => {
    ...
    link.href = '/manuals/Operating Manual SCR 2023.pdf'
    link.download = 'Operating Manual.pdf'
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="lg:text-xl text-base md:text-lg text-gray-600 font-medium max-w-3xl mx-auto leading-relaxed">
              Comprehensive guidelines and procedures for railway operations, signaling, train movements, and safety protocols
            </p>
          </div>
            ...
            <div className="relative space-y-8">
              ...
              <div className="text-center">
                    ...
                    <div className="relative bg-linear-to-r from-blue-500 to-indigo-600 rounded-2xl p-6 shadow-xl">
                      <div className="flex items-center justify-center gap-4">
                        ...
                        <div className="text-left">
                          ...
                          <p className="text-blue-100 text-sm md:text-base">Railway Operations Guide</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <p className="text-gray-700 text-lg md:text-xl leading-relaxed max-w-4xl mx-auto">
                  The Operating Manual is a comprehensive guide that provides essential procedures, rules, and regulations 
                  for railway operations. It covers train movements, signaling systems, track maintenance protocols, safety 
                  procedures, and operational guidelines that ensure efficient and safe railway operations. This manual serves 
                  as the cornerstone reference for all operational staff.
                </p>
              </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 border border-blue-100 hover:border-blue-200 transform hover:-translate-y-2">
                    <div className="text-center">
                      ...
                      <h3 className="text-xl font-bold text-gray-900 mb-2">Signaling Systems</h3>
                      <p className="text-gray-600 leading-relaxed text-sm">
                        Complete procedures for railway signaling, interlocking, and train control systems
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 border border-indigo-100 hover:border-indigo-200 transform hover:-translate-y-2">
                    <div className="text-center">
                      ...
                      <h3 className="text-xl font-bold text-gray-900 mb-2">Train Operations</h3>
                      <p className="text-gray-600 leading-relaxed text-sm">
                        Guidelines for train movements, scheduling, and operational procedures
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 border border-purple-100 hover:border-purple-200 transform hover:-translate-y-2">
                    <div className="text-center">
                      ...
                      <h3 className="text-xl font-bold text-gray-900 mb-2">Track Maintenance</h3>
                      <p className="text-gray-600 leading-relaxed text-sm">
                        Procedures for track inspection, maintenance schedules, and safety protocols
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-linear-to-br from-emerald-50 to-teal-50 rounded-xl p-5 border border-emerald-100 hover:border-emerald-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h4 className="font-bold text-gray-900 mb-1">General Operating Rules</h4>
                          <p className="text-gray-600 text-sm">Fundamental rules and regulations for railway operations</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="relative bg-linear-to-br from-blue-50 to-cyan-50 rounded-xl p-5 border border-blue-100 hover:border-blue-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">Comprehensive guidelines for signal operations and interlocking</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-linear-to-br from-purple-50 to-indigo-50 rounded-xl p-5 border border-purple-100 hover:border-purple-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        <span className="text-2xl">✓</span>
                        <div>
                          <h4 className="font-bold text-gray-900 mb-1">Train Control Systems</h4>
                          <p className="text-gray-600 text-sm">Procedures for train control, movement, and traffic management</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="relative bg-linear-to-br from-orange-50 to-amber-50 rounded-xl p-5 border border-orange-100 hover:border-orange-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">Essential safety measures and emergency procedures</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
                    Download the complete Operating Manual document with all procedures and operational guidelines
                  </p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        The Operating Manual is an indispensable resource for all railway operational staff. It establishes 
                        the standard operating procedures, safety protocols, and regulatory compliance requirements essential 
                        for efficient and safe railway operations. All personnel involved in train operations, signaling, 
                        track maintenance, and operational management must be thoroughly familiar with the guidelines outlined 
                        in this manual. Regular updates ensure that operational procedures remain current with technological 
                        advancements and safety standards.
                      </p>
                    </div>
                  </div>
                </div>
