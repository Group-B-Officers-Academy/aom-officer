...
const GSR = () => {
  const handleDownload = () => {
    ...
    link.href = '/manuals/Digital SCR G&SR 2020 upto AS 21.pdf'
    link.download = 'General and Subsidiary Rules.pdf'
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="lg:text-xl text-base md:text-lg text-gray-600 font-medium max-w-3xl mx-auto leading-relaxed">
              Comprehensive rules and regulations governing railway operations, safety protocols, and procedural guidelines for all railway personnel
            </p>
          </div>
            ...
            <div className="relative space-y-8">
              ...
              <div className="text-center">
                    ...
                    <div className="relative bg-linear-to-r from-blue-500 to-indigo-600 rounded-2xl p-6 shadow-xl">
                      <div className="flex items-center justify-center gap-4">
                        ...
                        <div className="text-left">
                          <h2 className="text-white font-bold text-xl md:text-2xl mb-1">General & Subsidiary Rules</h2>
                          <p className="text-blue-100 text-sm md:text-base">Railway Operations Manual</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <p className="text-gray-700 text-lg md:text-xl leading-relaxed max-w-4xl mx-auto">
                  The General & Subsidiary Rules (G&SR) is a fundamental document that establishes the core operational 
                  principles, safety regulations, and procedural guidelines for railway operations. It serves as the primary 
                  reference for all railway personnel, ensuring standardized practices, compliance with safety standards, 
                  and efficient railway management across all operational aspects.
                </p>
              </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 border border-blue-100 hover:border-blue-200 transform hover:-translate-y-2">
                    <div className="text-center">
                      ...
                      <h3 className="text-xl font-bold text-gray-900 mb-2">Operational Rules</h3>
                      <p className="text-gray-600 leading-relaxed text-sm">
                        Comprehensive guidelines governing day-to-day railway operations and procedures
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 border border-indigo-100 hover:border-indigo-200 transform hover:-translate-y-2">
                    <div className="text-center">
                      ...
                      <p className="text-gray-600 leading-relaxed text-sm">
                        Essential safety regulations and protocols for secure railway operations
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 border border-purple-100 hover:border-purple-200 transform hover:-translate-y-2">
                    <div className="text-center">
                      ...
                      <h3 className="text-xl font-bold text-gray-900 mb-2">Compliance Standards</h3>
                      <p className="text-gray-600 leading-relaxed text-sm">
                        Regulatory compliance requirements and standard operating procedures
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-linear-to-br from-emerald-50 to-teal-50 rounded-xl p-5 border border-emerald-100 hover:border-emerald-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h4 className="font-bold text-gray-900 mb-1">General Rules</h4>
                          <p className="text-gray-600 text-sm">Fundamental principles and rules applicable to all railway operations</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-linear-to-br from-blue-50 to-cyan-50 rounded-xl p-5 border border-blue-100 hover:border-blue-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        <span className="text-2xl">✓</span>
                        <div>
                          <h4 className="font-bold text-gray-900 mb-1">Subsidiary Rules</h4>
                          <p className="text-gray-600 text-sm">Specialized rules for specific operational departments and functions</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-linear-to-br from-purple-50 to-indigo-50 rounded-xl p-5 border border-purple-100 hover:border-purple-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        <span className="text-2xl">✓</span>
                        <div>
                          <h4 className="font-bold text-gray-900 mb-1">Operational Procedures</h4>
                          <p className="text-gray-600 text-sm">Step-by-step procedures for various railway operational tasks</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-linear-to-br from-orange-50 to-amber-50 rounded-xl p-5 border border-orange-100 hover:border-orange-200 transition-all duration-300">
                      <div className="flex items-start gap-3">
                        <span className="text-2xl">✓</span>
                        <div>
                          <h4 className="font-bold text-gray-900 mb-1">Regulatory Framework</h4>
                          <p className="text-gray-600 text-sm">Legal and regulatory requirements for railway operations</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
                    Download the complete General & Subsidiary Rules document with all regulations and guidelines
                  </p>
                  ...
                  <p className="text-sm text-gray-500 mt-4">
                    📄 General and Subsidiary Rules.pdf
                  </p>
                </div>
              </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        The General & Subsidiary Rules is an essential reference document for all railway personnel. 
                        It establishes the foundation for safe, efficient, and standardized railway operations. All employees 
                        must familiarize themselves with the relevant rules applicable to their roles and responsibilities. 
                        Regular updates and amendments ensure that the rules remain current with evolving operational requirements 
                        and safety standards. Compliance with these rules is mandatory for maintaining railway safety and operational excellence.
                      </p>
                    </div>
                  </div>
                </div>
