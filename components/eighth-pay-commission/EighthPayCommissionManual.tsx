...
const PDFViewer = dynamic(
  () => import('../../app/materials/eighth-pay-commission/eighth-pay-commission-manual/PDFViewer').then((mod) => ({ default: mod.default })),
...
const EighthPayCommissionManual = () => {
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="lg:text-xl text-base md:text-lg text-gray-600 font-medium max-w-3xl mx-auto leading-relaxed">
              Comprehensive summary of Eighth Pay Commission guidelines, procedures, and implementation details
            </p>
          </div>
            ...
            <div className="relative">
              <div className="text-center mb-4 sm:mb-6 md:mb-8">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto text-sm sm:text-base md:text-lg px-2">
                  Browse through the Eighth Pay Commission Summary page by page. Use controls below to navigate.
                </p>
              </div>
          ...
          <div className="mt-8 sm:mt-12 text-center">
            <Link
              href="/materials/eighth-pay-commission"
            ...
            >
              ...
              <span>Back to Eighth Pay Commission Topics</span>
            </Link>
          </div>
        </div>
      </section>
...
export default EighthPayCommissionManual
