...
const LangHaulSummary = () => {
  return (
    <Link href="/materials/opertating/long-haul-summary" className="block">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 text-sm">
              Comprehensive guide for long haul operations and procedures
            </p>
          </div>
...
export default LangHaulSummary