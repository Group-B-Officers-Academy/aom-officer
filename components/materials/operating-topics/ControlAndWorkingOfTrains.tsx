...
const PDFViewer = dynamic(
  () => import('../../../app/materials/opertating/control-and-working-of-trains/PDFViewer').then((mod) => ({ default: mod.default })),
...
const ControlAndWorkingOfTrains = () => {
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="lg:text-xl text-base md:text-lg text-gray-600 font-medium max-w-3xl mx-auto leading-relaxed">
              Comprehensive guide for train control systems, working procedures, and operational protocols for railway train operations
            </p>
          </div>
            ...
            <div className="relative">
              <div className="text-center mb-4 sm:mb-6 md:mb-8">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto text-sm sm:text-base md:text-lg px-2">
                  Browse through the Control And Working Of Trains page by page. Use controls below to navigate.
                </p>
              </div>
...
export default ControlAndWorkingOfTrains
