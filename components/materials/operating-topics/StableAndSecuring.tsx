...
const PDFViewer = dynamic(
  () => import('../../../app/materials/opertating/stabe-and-securing/PDFViewer').then((mod) => ({ default: mod.default })),
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <h1 className="lg:text-5xl text-3xl md:text-4xl font-black mb-6 leading-tight bg-clip-text text-transparent bg-linear-to-r from-blue-600 via-indigo-600 to-purple-600">
              Stable And Securing RDSO JPO Summary
            </h1>
            <p className="lg:text-xl text-base md:text-lg text-gray-600 font-medium max-w-3xl mx-auto leading-relaxed">
              Comprehensive guide for stable and securing procedures, RDSO Joint Procedure Orders, and operational protocols for railway safety
            </p>
          </div>
            ...
            <div className="relative">
              <div className="text-center mb-4 sm:mb-6 md:mb-8">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto text-sm sm:text-base md:text-lg px-2">
                  Browse through the Stable And Securing RDSO JPO Summary page by page. Use controls below to navigate.
                </p>
              </div>
          ...
          <div className="mt-8 sm:mt-12 text-center">
            ...
            >
              ...
              <span>Back to Operating Topics</span>
            </Link>
          </div>
        </div>
      </section>
...
export default StableAndSecuring
