...
//   () => import('../../../app/materials/advanced-operations/line-capacity-throughput/PDFViewer').then((mod) => ({ default: mod.default })),
...
//               Line Capacity Throughput
//             </h1>
//             <p className="lg:text-xl text-base md:text-lg text-gray-600 font-medium max-w-3xl mx-auto leading-relaxed">
//               Comprehensive guide for line capacity throughput systems, operational protocols, and procedures for railway line capacity management
//             </p>
//           </div>
...
//                   Browse through the Line Capacity Throughput page by page. Use controls below to navigate.
//                 </p>
//               </div>
