...
const PDFViewer = dynamic(
  () => import('../../../app/materials/advanced-operations/crew-power-rake-link/PDFViewer').then((mod) => ({ default: mod.default })),
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <h1 className="lg:text-5xl text-3xl md:text-4xl font-black mb-6 leading-tight bg-clip-text text-transparent bg-linear-to-r from-blue-600 via-indigo-600 to-purple-600">
              Crew Power Rake Link
            </h1>
            <p className="lg:text-xl text-base md:text-lg text-gray-600 font-medium max-w-3xl mx-auto leading-relaxed">
              Comprehensive guide for crew power rake link systems, operational protocols, and procedures for railway crew management
            </p>
          </div>
            ...
            <div className="relative">
              <div className="text-center mb-4 sm:mb-6 md:mb-8">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto text-sm sm:text-base md:text-lg px-2">
                  Browse through the Crew Power Rake Link page by page. Use controls below to navigate.
                </p>
              </div>
...
export default CrewPowerRakeLink