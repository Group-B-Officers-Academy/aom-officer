...
const PDFViewer = dynamic(
  () => import('../../../app/materials/advanced-operations/control-organisation/PDFViewer').then((mod) => ({ default: mod.default })),
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="lg:text-xl text-base md:text-lg text-gray-600 font-medium max-w-3xl mx-auto leading-relaxed">
              Comprehensive guide for control organisation systems, operational protocols, and procedures for railway control management
            </p>
          </div>
            ...
            <div className="relative">
              <div className="text-center mb-4 sm:mb-6 md:mb-8">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto text-sm sm:text-base md:text-lg px-2">
                  Browse through the Control Organisation page by page. Use controls below to navigate.
                </p>
              </div>
...
export default ControlOrganisation
